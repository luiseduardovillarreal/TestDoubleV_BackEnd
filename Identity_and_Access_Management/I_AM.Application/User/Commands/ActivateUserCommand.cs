...
internal class ActivateUserCommand(IUnitOfWork unitOfWork)
    : IRequestHandler<ActivateUserRequestDTO, CommonResponse<string>>
{
    private readonly IUnitOfWork _unitOfWork = unitOfWork;

    public async Task<CommonResponse<string>> Handle(ActivateUserRequestDTO request,
