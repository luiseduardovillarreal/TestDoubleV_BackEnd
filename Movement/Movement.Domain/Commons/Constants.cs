namespace Movement.Domain.Commons;
...
internal static class Constants
{
    internal static class Entities
    {
        ...
        {
            internal const string COMMENTS_ON_PROPERTIES_ID = "Id autogenerativo para la " +
                "llave principal de la tabla.";
            internal const string COMMENTS_ON_PROPERTIES_CREATE_AT = "Fecha de creación " +
                "del registro.";
            ...
            internal const string COMMENTS_ON_PROPERTIES_IS_ACTIVE = "Esta propiedad traducida " +
                "como ¿Está activo? Quiere decir que si el valor es true, es por que si está " +
                "activo el registro, o sea que el registro no está eliminado, pero si el valor " +
                "es false, quiere decir que el registro no está activo, o sea, está eliminado.";
            ...
            internal const string COMMENTS_ON_PROPERTIES_ID_SUB_MODULE = "Llave foránea de " +
                "referencia a la tabla TblSubModule.";
        ...
        internal static class CommonProperties
        {
            ...
            internal const string ID_USER_DEBTOR = "IdUserDebtor";
            internal const string ID_USER_CREDITOR = "IdUserCreditor";            
        }

        internal static class CommonTypeName
        {
        ...
        {
            internal const string TBL_MOVEMENT_DEBT = "TblMovementDebt";
            internal const string DIFFERENCE = "Difference";
            internal const string COMMENTS_ON_AMOUNT = "Valor del préstamo acordado " +
                "entre deudor y creditor.";
            internal const string COMMENTS_ON_DIFFERENCE = "Valor excedente para lograr " +
                "cubrir toda la deuda del préstamo.";
        }

        internal static class DebtMovement
        {
            internal const string TBL_MOVEMENT_DEBT_MOVEMENT = "TblMovementDebtMovement";
            internal const string ID_DEBT = "IdDebt";
            internal const string COMMENTS_ON_AMOUNT = "Valor del abono o pago a la deuda.";
            internal const string COMMENTS_ON_PROPERTIES_ID_DEBT = "Llave foránea de " +
                "referencia a la tabla TblMovementDebt.";
        }
        ...
        internal static class ForeignsKeys
        {
            ...
            internal const string FOREIGN_KEY_DEBT = "Debt";
        }
